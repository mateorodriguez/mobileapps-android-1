...
public class ActivityOne extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			...
			mCreate = (int)savedInstanceState.get("create");
			mRestart = (int) savedInstanceState.get("restart");
			mStart = (int)savedInstanceState.get("start");
			mResume = (int)savedInstanceState.get("resume");
